...
VALUES ("어린왕자들", "종이책", 0, "어리다..", "많이 어리다..", "김어림", 100, "목차입니다.", 20000, "2024-03-30");

INSERT INTO books (title, form, isbn, summary, detail, author, pages, contents, price, pub_date)
VALUES ("신데렐라들", "종이책", 1, "유리구두..", "투명한 유리구두..", "김구두", 100, "목차입니다.", 20000, "2023-03-31");
...
// 주문하기
// 배송 정보 입력
INSERT INTO delivery (address, receiver, contact) VALUES ("서울시 노원구", "압둘라", "010-2222-2222");
...
// 주문 상세 목록 입력
INSERT INTO ordered_book (order_id, book_id, quantity)
VALUES (order_id, 1, 1);
INSERT INTO ordered_book (order_id, book_id, quantity)
VALUES (order_id, 3, 2);
